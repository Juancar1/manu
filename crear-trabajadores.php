        ...
        <form role="form" method="post" name="guardar-registro-archivo" id="guardar-registro-archivo" action="modelo-trabajadores.php">
              <div class="box-body">
                      ...
                      <div class="form-group col-md-4">
                          ...
                          <input type="text" class="form-control" id="nombre" name="nombre" placeholder="Nombre" minlength="4" maxlength="20" required>
                      </div>
                      <div class="form-group col-md-4">
                          <label for="primer_apellido">Primer apellido: </label>
                          <input type="text" class="form-control" id="primer_apellido" name="primer_apellido" placeholder="Primer apellido" minlength="4" maxlength="20" required>
                      </div>
                      <div class="form-group col-md-4">
                          <label for="segundo_apellido">Segundo apellido: </label>
                          <input type="text" class="form-control" id="segundo_apellido" name="segundo_apellido" placeholder="Segundo apellido" maxlength="20">
                      </div>
                      <div class="form-group col-md-6">
                          <label for="ss">Número Seguridad Social: </label>
                          <input type="text" class="form-control" id="ss" name="ss" placeholder="" maxlength="12" minlength="12"/> 
                          <p class="help-block">Introduce los 12 números sin espacios</p>
                      </div>
                      <div class="form-group col-md-6">
                          <label for="banco">Número cuenta bancaria: </label>
                          <input type="text" class="form-control" id="banco" name="banco" placeholder="ES123456789..." minlength="24" maxlength="24">
                          <p class="help-block">Introduce los 24 carácteres sin espacios</p>
                      </div>
                      <div class="form-group col-md-6">
                          <label for="telefono">Telefono: </label>
                          <input type="text" class="form-control" id="telefono" name="telefono" placeholder="ej: 123456789" maxlength="9" minlength="9">
                      </div>
                      <div class="form-group col-md-6">
